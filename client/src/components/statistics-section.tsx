...
export default function StatisticsSection() {
  ...
  return (
    <section className="section-padding relative bg-gradient-to-br from-primary/95 via-primary to-primary/80 text-primary overflow-hidden">
            ...
            <ScrollReveal key={index} delay={index * 200}>
              <div className="text-center group" data-testid={`stat-${index}`}>
                <div className="relative">
                  ...
                  <div
                    className="text-4xl md:text-5xl lg:text-6xl font-bold text-primary mb-3 relative z-10 group-hover:scale-105 transition-transform duration-300"
                ...
                <div
                  className="text-primary/90 font-semibold text-sm lg:text-base uppercase tracking-wide"
