...
import { CheckCircle, ArrowRight, Hammer, Settings, Truck, Award } from "lucide-react";
  ...
  const services = [
    {
      ...
      description: "Complete fabrication solutions from concept to finished product"
    },
    {
    ...
    },
    {
      ...
      description: "Rigorous testing and quality control throughout the process"
    }
  ];
  ...
  const projects = [
    {
      ...
      features: ["Complex geometries", "Heavy-duty construction", "Certified welding"]
    },
    {
      title: "Process Equipment",
      description: "Specialized equipment for chemical and process industries",
      features: ["Pressure vessel code", "Exotic materials", "Precision assembly"]
    },
    {
      title: "Custom Machinery",
      description: "One-off machinery and automation equipment fabrication",
      features: ["Precision tolerances", "System integration", "Performance testing"]
    }
  ];
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto" data-testid="services-description">
              Comprehensive fabrication capabilities to handle projects of any size and complexity.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto" data-testid="capabilities-description">
              Advanced techniques and equipment for all aspects of metal fabrication.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {capabilities.map((capability, index) => (
              <div key={index} className="landify-card p-8" data-testid={`capability-${index}`}>
                <h3 className="text-2xl font-semibold text-foreground mb-6">{capability.category}</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto" data-testid="projects-description">
              Diverse fabrication projects across multiple industries and applications.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {projects.map((project, index) => (
              <div key={index} className="landify-card p-8" data-testid={`project-${index}`}>
      ...
      <section className="section-padding bg-secondary/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6" data-testid="industries-title">
              Industries We Serve
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {industries.map((industry, index) => (
              <div key={index} className="flex items-center space-x-3 landify-card p-6" data-testid={`industry-${index}`}>
      ...
      <section className="section-padding bg-primary text-primary-foreground" id="contact">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 opacity-90" data-testid="cta-description">
            From concept to completion, our fabrication experts will work with you to bring your project to life with precision and quality.
          </p>
