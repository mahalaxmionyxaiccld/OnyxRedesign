...
export default function MachiningPage() {
  ...
  const capabilities = [
    ...
    },
    {
      ...
      description:
        "High-Quality Large Format CNC Milling 1-Day Expedite Available. Free Shipping on All US and International Orders.",
    },
    {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              >
                Get instant quotes on custom metal and plastic machined parts
                with our Online CNC Machining Service. Make quick turn
                prototypes and production parts in days with free standard
                shipping on all US orders. ISO 9001:2015, ISO 13485, IATF
                16949:2016, and AS9100D certified. ITAR registered.
              </p>
      ...
      <section className="section-padding bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            >
              Onyx provides a custom online CNC machining service to engineers,
              product developers, designers, and more through our vetted network
              of suppliers. Our highly qualified AS9100D machine shops can make
              any custom design, simple or complex.
            </p>
          </div>
      ...
      <section className="section-padding bg-secondary/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            >
              Comprehensive machining solutions for all your precision
              manufacturing needs.
            </p>
          </div>
      ...
      <section className="section-padding bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            >
              Expertise across a wide range of metals, alloys, and engineering
              plastics.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {materials.map((material, index) => (
              <div
                key={index}
                className="flex items-center space-x-3 landify-card p-4"
      ...
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 opacity-90" data-testid="cta-description">
            Get a quote for your machining project. Our team of experts will
            work with you to deliver precision parts that meet your exact
            specifications.
          </p>
