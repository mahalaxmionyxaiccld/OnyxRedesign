...
import { CheckCircle, ArrowRight, Droplets, Clock, Palette, Award } from "lucide-react";
  ...
  const advantages = [
    {
      ...
      description: "Bubble-free castings with excellent surface finish and fine detail reproduction"
    },
    {
      icon: <Clock className="h-6 w-6 text-primary" />,
      title: "Rapid Prototyping",
      description: "Quick turnaround for prototype parts and low-volume production runs"
    },
    {
      icon: <Palette className="h-6 w-6 text-primary" />,
      title: "Material Variety",
      description: "Wide range of polyurethane resins with different properties and colors"
    },
    {
      icon: <Award className="h-6 w-6 text-primary" />,
      title: "Cost Effective",
      description: "Economical solution for small to medium production quantities"
    }
  ];
  ...
  const applications = [
    {
      ...
      description: "Functional prototypes that closely match final production properties",
      benefits: ["Material validation", "Fit and function testing", "Market validation"]
    },
    {
      title: "Low-Volume Production",
      description: "Cost-effective production for specialized or limited-run products",
    ...
    },
    {
      ...
      benefits: ["No minimum quantities", "Match original specs", "Fast delivery"]
    }
  ];
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="section-padding bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6" data-testid="advantages-title">
              Vacuum Casting Advantages
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto" data-testid="advantages-description">
              Experience the benefits of vacuum casting for your prototyping and low-volume production needs.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {advantages.map((advantage, index) => (
              <div key={index} className="landify-card p-6 text-center" data-testid={`advantage-${index}`}>
      ...
      <section className="section-padding bg-secondary/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6" data-testid="applications-title">
              Applications & Use Cases
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto" data-testid="applications-description">
              Versatile vacuum casting solutions for diverse industry requirements.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {applications.map((application, index) => (
              <div key={index} className="landify-card p-8" data-testid={`application-${index}`}>
                <h3 className="text-2xl font-semibold text-foreground mb-4">{application.title}</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto" data-testid="materials-description">
              Comprehensive range of polyurethane resins for different application requirements.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {materials.map((material, index) => (
              <div key={index} className="landify-card p-8" data-testid={`material-${index}`}>
                <h3 className="text-xl font-semibold text-foreground mb-3">{material.name}</h3>
                <p className="text-muted-foreground mb-4">{material.properties}</p>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground" data-testid="process-description">
              Professional vacuum casting process ensuring consistent quality and finish.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {process.map((step, index) => (
              <div key={index} className="landify-card p-6 text-center" data-testid={`process-step-${index}`}>
      ...
      <section className="section-padding bg-primary text-primary-foreground" id="contact">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 opacity-90" data-testid="cta-description">
            Transform your designs into high-quality polyurethane parts with our vacuum casting services. Get a quote today!
          </p>
