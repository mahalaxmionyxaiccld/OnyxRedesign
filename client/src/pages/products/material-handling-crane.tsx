  ...
  const features = [
    {
      ...
      title: "Design",
      description:
        "Crafting innovative designs that balance functionality, precision, and aesthetics for superior products.",
    },
    {
      icon: <Truck className="h-6 w-6 text-primary" />,
      title: "Engineering",
      description:
        "Delivering expert engineering solutions that ensure efficiency, accuracy, and reliability in every project.",
    },
    {
      icon: <Settings className="h-6 w-6 text-primary" />,
      title: "Material",
      description:
        "Using high-quality, durable materials to guarantee product longevity, performance, and customer satisfaction.",
    },
    {
      icon: <Shield className="h-6 w-6 text-primary" />,
      title: "Manufacturing",
      description:
        "Employing advanced manufacturing techniques to produce flawless, high-precision products at every scale.",
    },
  ];
  ...
  const applications = [
    {
      ...
      description:
        "Heavy lifting for building construction and infrastructure projects",
    },
    {
      title: "Manufacturing Facilities",
      description:
        "Material handling in production environments and warehouses",
    },
    {
      title: "Port Operations",
      description:
        "Container handling and cargo operations at ports and terminals",
    },
    {
      title: "Steel Industry",
      description:
        "Moving heavy steel components and machinery in industrial settings",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              >
                Precision-engineered products that uphold the highest standards
                of quality and the trust of our valued clients. At Onyx
                Industries, we deliver precision-engineered products built with
                superior quality and reliability across 58+ installations, 25+
                happy clients, and 60+ services completed.
              </p>
      ...
      <section className="section-padding bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            >
              Our material handling cranes combine cutting-edge technology with
              robust engineering to deliver superior performance in demanding
              environments.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2
                ...
                data-testid="specifications-title"
              >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {specifications.map((spec, index) => (
                  <div
                    ...
                    data-testid={`specification-${index}`}
                  >
      ...
      <section className="section-padding bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            >
              Our material handling cranes are designed to excel in a wide range
              of industrial environments and applications.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {applications.map((app, index) => (
              <div
                key={index}
                className="p-8 bg-card rounded-lg border shadow-sm hover:shadow-md transition-shadow"
      ...
      <section className="section-padding bg-primary text-primary-foreground">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 opacity-90" data-testid="cta-description">
            ...
            get a customized quote for your material handling crane solution.
          </p>
